...
public class jdbc {
    ...
    public boolean insert(String table, String column, List<Object> values) {
        try {
            String insertTemplate = InsertSqlTemplate(table, column, values.size());
    ...
    private String InsertSqlTemplate(String table, String column, int valueAmount) {
        return "insert into " + table + " " + column + " values (?" +
                (Math.max(0, valueAmount - 1)) + ")";
    }

    public List<Map<String, Object>> query(String table, Map<String, Object> values, String condition) {
        try {
            String sqlTemplate = QuerySqlTemplate(table, values, condition);
    ...
    public String QuerySqlTemplate(String table, Map<String, Object> values, String condition) {
